(function (root, factory) {
    ...
    var TableExport = function (selectors, options) {
        ...
        if (!self)
            return new TableExport(selectors, options);
        ...
        self.selectors.forEach(function (el) {
            ...
            context.checkCaption = function (exportButton) {
                ...
                if (caption.length) {
                    ...
                    caption.style.cssText = "caption-side: " + settings + ";position: absolute;top: 11.5%;left: 17%;";
    ...
    TableExport.prototype = {
        ...
        formatConfig: {
            ...
            xlsx: {
                defaultClass: "xlsx",
                buttonContent: "Exportar a EXCEL XLSX",
            ...
            xls: {
                defaultClass: "xls",
                buttonContent: "Exportar a EXCEL XLS",
                separator: "\t",
        ...
        createSheet: function (data, merges) {
            ...
            for (var R = 0; R !== data.length; ++R) {
                for (var C = 0; C !== data[R].length; ++C) {
                    ...
                    if (!cell.t) {
                        if (types.number.assert(cell.v))
                            cell.t = _TYPE.NUMBER;
                        else if (types.boolean.assert(cell.v))
                            cell.t = _TYPE.BOOLEAN;
                        else if (types.date.assert(cell.v))
                            cell.t = _TYPE.DATE;
                        else
                            cell.t = _TYPE.STRING;
                    }
    ...
    var Storage = function () {
        ...
        this.setItem = function (_key, value, overwrite) {
            ...
            if (typeof value !== "string")
                return _handleError('"value" must be a string.');
